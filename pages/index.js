...
const BLACK_CARDS = [
  ...
  { text: "Mr. and Mrs. Diaz, we called you in because we're concerned about Cynthia. Are you aware that your daughter is ___?", pick: 1 },
...
const WHITE_CARDS = [
  ...
  "Working in an Amazon warehouse.", "A fart so powerful that it wakes the giants from their thousand-year slumber.", "Former President George W. Bush.", "Full frontal nudity.",
  ...
  "Having big dreams but no realistic way to achieve them.", "Seeing Grandma naked.", "Boogers.", "The Confederate flag.",
  "The miracle of childbirth.", "A positive attitude!", "Having a stroke.", "White privilege.",
  "Emerging from the sea and rampaging through Tokyo.", "The Hamburglar.", "The tampon from my vagina.", "The Blood of Christ.",
  ...
  "Alexandria Ocasio-Cortez.", "Putting things where they go.", "Holding a pepper grinder for some reason.", "Giving birth in prison.",
  ...
  "Da clubr.", "Dead birds everywhere.", "The arrival of the pizza.", "Permanent Orgasm-Face Disorder.",
  "The cool, refreshing taste of Pepsi.", "Irritable bowel syndrome.", "Oprah.", "Wondering if it's possible to get some of that salsa to go.",
  "Bananas.", "Cringe.", "Me jubbly bubblies.", "Switching to Geico.",
  "Peeing a little bit.", "Wet dreams.", "The Jews.", "My cheating son-of-a-bitch husband.",
  "Powerful thighs.", "These hoes.", "The only gay person in a hundred miles.", "Having sex for the first time.",
  ...
  "Poverty.", "Kamala Harris.", "A loser like you.",
  "A mistake.", "Squirting.", "Wizard music.", "The Kool-Aid Man.",
  "Explaining the difference between sex and gender.", "Free samples.", "Hurting those closest to me.", "Feeding strawberries to my manslut.",
  "The Three-Fifths Compromise.", "Lactation.", "Laughing over champagne flutes while the poor freeze to death outside.", "Shutting up so I can watch the game.",
  "Eating a hard boiled egg out of my husband's asshole.", "Doing white people shit with a bunch of white people.", "One titty hanging out.", "Fucking all my dad's friends.",
  ...
  "Getting fingered.", "My Uber driver, Pavel.", "GoGurt.", "Police brutality.",
  ...
  "Critical race theory.", "Adderall.", "Your mom.", "Sideboob.",
  "An octopus giving seven handjobs and smoking a cigarette.", "My neck, my back, my pussy, and my crack.", "J.D. Power and his associates.", "Mouth herpes.",
  ...
  "Getting crushed by a vending machine.", "My inner demons.", "A Super Soaker full of cat pee.", "Aunt Jemima's racist pancake sauce.",
  "Cuddling.", "However much weed $20 can buy.", "Battlefield amputations.", "Spaghetti? Again?",
  "Ronald Reagan.", "A disappointing birthday party.", "Nachos for the table.", "Becoming a blueberry.",
  "A tiny horse.", "Crab.", "Selling crack to children.", "The Wendy's Spicy Chicken Sandwich.",
  "Brown people.", "Sexually active band geeks.", "Pedophiles.", "Yeast.",
  "How bad my daughter fucked up her dance recital.", "Rectangles.", "Being fucking pathetic.", "Poor people.",
  "Only dating Asian women.", "Putting children in cages.", "Karen.", "How amazing it is to be on mushrooms.",
  "Judging everyone.", "An all-white jury.", "Getting married, having a few kids, buying some stuff, retiring to Florida, and dying.", "Some god damn peace and quiet.",
  ...
  "Accepting the way things are.", "NBA superstar LeBron James.", "Listening to her problems without trying to solve them.", "Therapy.",
  ...
  "Some punk kid who stole my turkey sandwich.", "Heartwarming orphans.", "Spirit Airlines.", "Bubble butt bottom boys.",
  "A bowl of mayonnaise and human teeth.", "Fiery poops.", "Saying 'I love you.'", "Inserting a Mason jar into my anus.",
  ...
  "Hobos.", "Queefing.", "My fuckslave, Reginald.", "Cardi B.",
  ...
  "Natural gas.", "Over 10,000 Guatemalan migrants.", "Toxic masculinity.", "My relationship status.",
  ...
  "Opposable thumbs.", "Racially-biased SAT questions.", "The Great Depression.", "Chainsaws for hands.",
  ...
  "Bryan Cranston, of all people.", "Vehicular manslaughter.", "Women's suffrage.", "Some guy.",
  "Judge Judy.", "Climbing a telephone pole and becoming one with the T-Mobile network.", "This month's mass shooting.", "Barack Obama.",
  "Illegal immigrants.", "My horny, horny son.", "The female orgasm.", "Heteronormativity.",
  "Crumbs all over the god damn carpet.", "Corporate America.", "The wifi password.", "A time-traveling Chinese general from the Shang Dynasty.",
  "A bird that shits human turds.", "A mopey zoo lion.", "Pro-life protesters.", "Poor life choices.",
  ...
  "Me time.", "The Underground Railroad.", "Kayaking with my sluts.", "Boppin' my flopper.",
  "Lumberjack fantasies.", "Goat.", "Women in yogurt commercials.", "Literally begging to die.",
  ...
  "Calling the cops on an innocent Black man.", "My ugly face and bad personality.", "A bitch slap.", "A brain tumor.",
